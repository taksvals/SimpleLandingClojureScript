...
if((x instanceof cljs.core.Keyword)){
var G__49561 = spec;
var G__49562 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__49561,G__49562) : f.call(null,G__49561,G__49562));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__49563 = spec;
var G__49564 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__49563,G__49564) : f.call(null,G__49563,G__49564));
} else {
return x;
...
if(typeof x === 'number'){
var G__49580 = spec;
var G__49581 = spec_tools.transform.number__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__49580,G__49581) : f.call(null,G__49580,G__49581));
} else {
if(typeof x === 'string'){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(spec,x) : f.call(null,spec,x));
} else {
...
}catch (e49582){if((e49582 instanceof Error)){
var ___$1 = e49582;
return x;
} else {
throw e49582;
...
}catch (e49604){if((e49604 instanceof Error)){
var ___$1 = e49604;
return x;
} else {
throw e49604;
...
}catch (e49623){if((e49623 instanceof Error)){
var ___$1 = e49623;
return x;
} else {
throw e49623;
...
}catch (e49624){if((e49624 instanceof Error)){
var ___$1 = e49624;
return x;
} else {
throw e49624;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__49638,x){
var map__49648 = p__49638;
var map__49648__$1 = cljs.core.__destructure_map(map__49648);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49648__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__49657,x){
var map__49658 = p__49657;
var map__49658__$1 = cljs.core.__destructure_map(map__49658);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49658__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__49661,x){
var map__49662 = p__49661;
var map__49662__$1 = cljs.core.__destructure_map(map__49662);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49662__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
