...
var vec__49444 = cljs.core.rest(expr);
var seq__49445 = cljs.core.seq(vec__49444);
var first__49446 = cljs.core.first(seq__49445);
var seq__49445__$1 = cljs.core.next(seq__49445);
var vec__49447 = first__49446;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49447,(0),null);
var form = seq__49445__$1;
...
var G__49454 = x;
var G__49454__$1 = (((G__49454 == null))?null:spec_tools.impl.polish(G__49454));
var G__49454__$2 = (((G__49454__$1 == null))?null:cljs.core.name(G__49454__$1));
if((G__49454__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__49454__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__49455 = x;
var G__49455__$1 = (((G__49455 == null))?null:cljs.core.name(G__49455));
if((G__49455__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__49455__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__49456){
var map__49457 = p__49456;
var map__49457__$1 = cljs.core.__destructure_map(map__49457);
var data = map__49457__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49457__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49457__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49457__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49457__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__49458){
var map__49459 = p__49458;
var map__49459__$1 = cljs.core.__destructure_map(map__49459);
var data = map__49459__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49459__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49459__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__49460 = data;
var G__49460__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__49460,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__49460);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__49460__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__49460__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__49469 = form;
var G__49469__$1 = (((G__49469 == null))?null:cljs.core.rest(G__49469));
if((G__49469__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__49469__$1);
}
})();
var G__49470 = m;
var G__49470__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__49470,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__49462_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__49462_SHARP_)));
})):G__49470);
var G__49470__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__49470__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__49463_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__49463_SHARP_)));
})):G__49470__$1);
var G__49470__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__49470__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__49464_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__49464_SHARP_));
})):G__49470__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__49470__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__49471 = (function (){var G__49472 = form;
var G__49472__$1 = (((G__49472 == null))?null:cljs.core.rest(G__49472));
if((G__49472__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__49472__$1);
}
})();
var map__49471__$1 = cljs.core.__destructure_map(map__49471);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49471__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49471__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49471__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49471__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__49483 = (function (){var and__4221__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__49490 = form;
var G__49490__$1 = (((G__49490 == null))?null:cljs.core.seq(G__49490));
var G__49490__$2 = (((G__49490__$1 == null))?null:cljs.core.first(G__49490__$1));
if((G__49490__$2 == null)){
return null;
} else {
var fexpr__49491 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__49491.cljs$core$IFn$_invoke$arity$1 ? fexpr__49491.cljs$core$IFn$_invoke$arity$1(G__49490__$2) : fexpr__49491.call(null,G__49490__$2));
}
})():null));
});
/**
...
var len__4829__auto___49519 = arguments.length;
var i__4830__auto___49520 = (0);
while(true){
if((i__4830__auto___49520 < len__4829__auto___49519)){
args__4835__auto__.push((arguments[i__4830__auto___49520]));

var G__49521 = (i__4830__auto___49520 + (1));
i__4830__auto___49520 = G__49521;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq49492){
var self__4817__auto__ = this;
return self__4817__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq49492));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__49496){
var vec__49497 = p__49496;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49497,(0),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__49502){
var map__49503 = p__49502;
var map__49503__$1 = cljs.core.__destructure_map(map__49503);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49503__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49503__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49503__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49503__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__49500_SHARP_){
return cljs.core.map_QMARK_(p1__49500_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__49501_SHARP_){
return cljs.core.contains_QMARK_(p1__49501_SHARP_,x);
});
}),req_keys));
