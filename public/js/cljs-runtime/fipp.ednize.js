...
var fipp$ednize$IEdn$_edn$dyn_51005 = (function (x){
var x__4521__auto__ = (((x == null))?null:x);
var m__4522__auto__ = (fipp.ednize._edn[goog.typeOf(x__4521__auto__)]);
...
var m__4519__auto__ = (fipp.ednize._edn["_"]);
...
return fipp$ednize$IEdn$_edn$dyn_51005(x);
}
});
...
return cljs.core.tagged_literal(new cljs.core.Symbol(null,"js","js",-886355190,null),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4622__auto__ = (function fipp$ednize$edn_$_iter__50985(s__50986){
return (new cljs.core.LazySeq(null,(function (){
var s__50986__$1 = s__50986;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__50986__$1);
if(temp__5753__auto__){
var s__50986__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__50986__$2)){
var c__4620__auto__ = cljs.core.chunk_first(s__50986__$2);
var size__4621__auto__ = cljs.core.count(c__4620__auto__);
var b__50988 = cljs.core.chunk_buffer(size__4621__auto__);
if((function (){var i__50987 = (0);
while(true){
if((i__50987 < size__4621__auto__)){
var k = cljs.core._nth(c__4620__auto__,i__50987);
cljs.core.chunk_append(b__50988,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null));

var G__51006 = (i__50987 + (1));
i__50987 = G__51006;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50988),fipp$ednize$edn_$_iter__50985(cljs.core.chunk_rest(s__50986__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50988),null);
}
} else {
var k = cljs.core.first(s__50986__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(x[k])], null),fipp$ednize$edn_$_iter__50985(cljs.core.rest(s__50986__$2)));
}
} else {
return null;
}
...
return iter__4622__auto__(cljs.core.js_keys(x));
})()));
} else {
...
var pending_QMARK_ = (function (){var and__4221__auto__ = (((!((x == null))))?(((((x.cljs$lang$protocol_mask$partition1$ & (1))) || ((cljs.core.PROTOCOL_SENTINEL === x.cljs$core$IPending$))))?true:(((!x.cljs$lang$protocol_mask$partition1$))?cljs.core.native_satisfies_QMARK_(cljs.core.IPending,x):false)):cljs.core.native_satisfies_QMARK_(cljs.core.IPending,x));
