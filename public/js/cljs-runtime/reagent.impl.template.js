...
var G__44508 = o;
goog.object.set(G__44508,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__44512 = o;
goog.object.set(G__44512,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__44543__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__44544__i < G__44544__a.length) {G__44544__a[G__44544__i] = arguments[G__44544__i + 0]; ++G__44544__i;}
  args = new cljs.core.IndexedSeq(G__44544__a,0,null);
} 
return G__44543__delegate.call(this,args);};
G__44543.cljs$lang$maxFixedArity = 0;
G__44543.cljs$lang$applyTo = (function (arglist__44545){
var args = cljs.core.seq(arglist__44545);
return G__44543__delegate(args);
});
...
var G__44513 = props;
var G__44513__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44513,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__44513);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44513__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__44513__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__44514 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__44514,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__44514;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__44515){
var map__44516 = p__44515;
var map__44516__$1 = cljs.core.__destructure_map(map__44516);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44516__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__44517_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__44517_SHARP_);
}));
} else {
return null;
}
...
var vec__44519 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44519,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44519,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44519,(2),null);
...
var temp__5757__auto___44551 = reagent.impl.template.key_from_vec(v);
if((temp__5757__auto___44551 == null)){
} else {
var key_44552 = temp__5757__auto___44551;
(jsprops.key = key_44552);
}
...
var temp__5757__auto___44553 = reagent.impl.template.key_from_vec(argv);
if((temp__5757__auto___44553 == null)){
} else {
var key_44554 = temp__5757__auto___44553;
(jsprops.key = key_44554);
}
...
var G__44523 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__44523) : reagent.impl.template.as_element.call(null,G__44523));
} else {
var temp__5757__auto___44555 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5757__auto___44555 == null)){
} else {
var key_44556 = temp__5757__auto___44555;
(jsprops.key = key_44556);
}
...
var G__44525 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__44525)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__44525)){
return x;
} else {
...
var len__4829__auto___44557 = arguments.length;
var i__4830__auto___44558 = (0);
while(true){
if((i__4830__auto___44558 < len__4829__auto___44557)){
args__4835__auto__.push((arguments[i__4830__auto___44558]));

var G__44559 = (i__4830__auto___44558 + (1));
i__4830__auto___44558 = G__44559;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq44526){
var G__44527 = cljs.core.first(seq44526);
var seq44526__$1 = cljs.core.next(seq44526);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44527,seq44526__$1);
}));
...
break;
default:
var G__44561 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__44561;
continue;
...
var ctx = ({});
var vec__44530 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44530,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44530,(1),null);
...
var G__44533 = (cljs.core.count(argv) - first_child);
switch (G__44533) {
case (0):
