...
return cljs.core.boolean$((function (){var or__4223__auto__ = cljs.core.some(cljs.core.some_fn.cljs$core$IFn$_invoke$arity$3(cljs.core.nil_QMARK_,meta_merge.core.displace_QMARK_,meta_merge.core.replace_QMARK_),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [left,right], null));
...
if(cljs.core.truth_((function (){var and__4221__auto__ = meta_merge.core.displace_QMARK_(left);
...
if(cljs.core.truth_((function (){var and__4221__auto__ = meta_merge.core.replace_QMARK_(left);
if(cljs.core.truth_(and__4221__auto__)){
...
if(cljs.core.truth_((function (){var or__4223__auto__ = meta_merge.core.displace_QMARK_(left);
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
return meta_merge.core.replace_QMARK_(right);
...
if(cljs.core.truth_((function (){var or__4223__auto__ = meta_merge.core.replace_QMARK_(left);
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
return meta_merge.core.displace_QMARK_(right);
...
var len__4829__auto___46325 = arguments.length;
var i__4830__auto___46326 = (0);
while(true){
if((i__4830__auto___46326 < len__4829__auto___46325)){
args_arr__4850__auto__.push((arguments[i__4830__auto___46326]));

var G__46327 = (i__4830__auto___46326 + (1));
i__4830__auto___46326 = G__46327;
continue;
} else {
}
break;
...
return meta_merge.core.meta_merge.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__4851__auto__);
...
if(cljs.core.truth_((function (){var or__4223__auto__ = new cljs.core.Keyword(null,"prepend","prepend",342616040).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(left));
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
...
/** @this {Function} */
(meta_merge.core.meta_merge.cljs$lang$applyTo = (function (seq46296){
var G__46297 = cljs.core.first(seq46296);
var seq46296__$1 = cljs.core.next(seq46296);
var G__46298 = cljs.core.first(seq46296__$1);
var seq46296__$2 = cljs.core.next(seq46296__$1);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46297,G__46298,seq46296__$2);
}));
