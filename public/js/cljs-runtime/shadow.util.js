...
var len__4829__auto___46818 = arguments.length;
var i__4830__auto___46819 = (0);
while(true){
if((i__4830__auto___46819 < len__4829__auto___46818)){
args_arr__4850__auto__.push((arguments[i__4830__auto___46819]));

var G__46820 = (i__4830__auto___46819 + (1));
i__4830__auto___46819 = G__46820;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq46693){
...
var G__46696 = cljs.core.first(seq46693__$2);
var seq46693__$3 = cljs.core.next(seq46693__$2);
var G__46697 = cljs.core.first(seq46693__$3);
var seq46693__$4 = cljs.core.next(seq46693__$3);
var G__46698 = cljs.core.first(seq46693__$4);
var seq46693__$5 = cljs.core.next(seq46693__$4);
var G__46699 = cljs.core.first(seq46693__$5);
var seq46693__$6 = cljs.core.next(seq46693__$5);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46694,G__46695,G__46696,G__46697,G__46698,G__46699,seq46693__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__46759){
var vec__46760 = p__46759;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46760,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46760,(1),null);
