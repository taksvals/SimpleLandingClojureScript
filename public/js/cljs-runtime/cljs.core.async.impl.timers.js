...
var i_43120 = (0);
while(true){
if((i_43120 < arr.length)){
(arr[i_43120] = null);

var G__43121 = (i_43120 + (1));
i_43120 = G__43121;
continue;
} else {
}
...
var i_43129 = (self__.level + (1));
while(true){
if((i_43129 <= (new_level + (1)))){
(update[i_43129] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_43134 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_43134[i]));
} else {
x__$2.forward.push((((i < links_43134.length))?(links_43134[i]):null));
}

if((i < links_43134.length)){
(links_43134[i] = x__$2);
} else {
links_43134.push(x__$2);
}
...
var i_43136 = (0);
while(true){
if((i_43136 <= self__.level)){
var links_43137 = (update[i_43136]).forward;
if((x__$1 === (((i_43136 < links_43137.length))?(links_43137[i_43136]):null))){
(links_43137[i_43136] = (x__$1.forward[i_43136]));

var G__43138 = (i_43136 + (1));
i_43136 = G__43138;
continue;
} else {
var G__43139 = (i_43136 + (1));
i_43136 = G__43139;
continue;
}
} else {
...
var G__43142 = nx;
var G__43143 = (level__$1 - (1));
x = G__43142;
level__$1 = G__43143;
continue;
} else {
var G__43144 = x;
var G__43145 = (level__$1 - (1));
x = G__43144;
level__$1 = G__43145;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__43147 = nx;
var G__43148 = (level__$1 - (1));
x = G__43147;
level__$1 = G__43148;
continue;
} else {
var G__43149 = x;
var G__43150 = (level__$1 - (1));
x = G__43149;
level__$1 = G__43150;
continue;
}
